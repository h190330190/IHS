...
<form action="select" method="post">
      <a href="welcomedoc.html"><p style="color:white;"><div style="text-align:center" class="button button1"><div style="font-size: 16px;">View Disease</div></div></a></p>
      <a href="ModifyDisease.jsp"><p style="color:white;"><div style="text-align:center" class="button button1"><div style="font-size: 16px;">Modify Symptoms</div></div></a></p>
      <br>
     <hr>
      </form>
<br>
