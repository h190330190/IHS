...
.bg-img {
  /* The image used */
  background-image: url("https://st3.depositphotos.com/9792280/12768/i/950/depositphotos_127682558-stock-photo-tablets-isolated-on-a-white.jpg");
...
<ul>
  ...
  <form action="PMLogic.jsp" method="post" class="container">
    <h1><div style="text-align:center"><div style="font-family: Georgia, 'Times New Roman', Times, serif;">Enter Prescription</div></div></h1>
    <input type="text" placeholder="Enter Patient ID" name="pid" required>
    <input type="text" placeholder="Enter Prescription" name="Medicines" required>
    <br>
    <button type="submit" class="btn">
    <div style="text-align:center">
    <div style="font-size: 18px;">Submit</div></div></button>
    <br>
