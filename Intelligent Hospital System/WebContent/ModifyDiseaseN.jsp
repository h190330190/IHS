...
<ul>
  ...
  <form action="ModifyDiseaseNLogic.jsp" method="post" class="container">
    <h1><div style="text-align:center"><div style="font-family: Georgia, 'Times New Roman', Times, serif;">Modify Symptoms</div></div></h1>
    <input type="text" placeholder="Enter Disease ID" name="did" required>
    <input type="text" placeholder="Enter Modified Symptoms" name="Symptoms" required>
    <br>
